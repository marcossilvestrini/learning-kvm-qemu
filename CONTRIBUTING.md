...
1. You [open a discussion](https://github.com/marcossilvestrini/learning-aws-cloud-practitioner-essentials/discussions) to discuss any significant work with the maintainer(s).
...
```shell
git remote add upstream https://github.com/marcossilvestrini/aws-cloud-practitioner-essentials.git
...
discuss, [open a discussion](https://github.com/marcossilvestrini/aws-cloud-practitioner-essentials/discussions).
